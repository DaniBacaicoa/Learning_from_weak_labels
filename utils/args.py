...
def parse_args():
    ...
    # optional args
    parser.add_argument('--type', help='optimizer\'s learning rate', type=str, default='pll')
    
    parser.add_argument('--lr', help='optimizer\'s learning rate', type=float, default=1e-2)
    parser.add_argument('--id', help='specify a dataset', type=str, default='mnist',
                        choices=['mnist', 'fmnist', 'kmnist', 'cifar10', 'lost', 'MSRCv2', 'birdac', 'spd', 'LYN'])
